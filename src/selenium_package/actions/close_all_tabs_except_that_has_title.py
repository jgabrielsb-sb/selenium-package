"""
This module contains the CloseAllTabsExceptThatHasTitle action.
It will close all tabs except the one that has the exact same title passed to the constructor.
"""
...
class CloseAllTabsExceptThatHasTitle(BaseAction):
    def __init__(
        ...
        """
        Initialize the CloseAllTabsExceptThatHasTitle action.
        This action will close all tabs except the one that has the exact same title 
