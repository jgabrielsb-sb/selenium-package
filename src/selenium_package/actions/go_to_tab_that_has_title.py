"""
This module contains the GoToTabThatHasTitle action.
It will go to the tab that has the exact same title passed to the constructor.
"""
...
class GoToTabThatHasTitle(BaseAction):
    def __init__(
        ...
        This action will go to the tab that has the exact same title passed to the constructor.
        Args:
