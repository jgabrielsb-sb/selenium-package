...
from selenium_package.actions import GoToTabThatContainsTitle
...
class TestGoToTabThatContainsTitle:
    ...
    def test_if_returns_desired_tab_id_when_desired_tab_title_is_found(
        ...
        class MockWebDriver:
            ...
            def __init__(self):
                self.titles_for_window_handles = {
                    "tab_1": "tab_1_title",
                    "tab_2": "desired title and something more",
                    "tab_3": "tab_3_title",
                }
        ...
        go_to_tab_that_contains_title_instance = GoToTabThatContainsTitle(
            web_instance=mock_webdriver,
            desired_tab_title='desired title'
        )
        
        desired_tab_id = go_to_tab_that_contains_title_instance._return_desired_tab_id_by_title()
    ...
    def test_if_raises_value_error_if_desired_tab_is_not_found(
        ...
        with pytest.raises(ValueError) as e:
            go_to_tab_that_contains_title_instance._return_desired_tab_id_by_title()
